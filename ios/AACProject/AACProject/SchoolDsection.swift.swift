...
@available(iOS 15.0, *)
class SchoolDsection: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        button1 .setImage(UIImage(named: "122.png"), for: .normal)  // 교과서
           button2 .setImage(UIImage(named: "123.png"), for: .normal)  // 공책
           button3 .setImage(UIImage(named: "124.png"), for: .normal)  // 필통
           button4 .setImage(UIImage(named: "125.png"), for: .normal)  // 연필
           button5 .setImage(UIImage(named: "126.png"), for: .normal)  // 지우개
           button6 .setImage(UIImage(named: "127.png"), for: .normal)  // 사물함
           button7 .setImage(UIImage(named: "128.png"), for: .normal)  // 책상
           button8 .setImage(UIImage(named: "129.png"), for: .normal)  // 의자
           button9 .setImage(UIImage(named: "130.png"), for: .normal)  // 가방
           button10.setImage(UIImage(named: "131.png"), for: .normal)  // 실내화
           button11.setImage(UIImage(named: "132.png"), for: .normal)  // 색연필
           button12.setImage(UIImage(named: "1132.png"), for: .normal) // 사인펜
           button13.setImage(UIImage(named: "133.png"), for: .normal)  // 풀
           button14.setImage(UIImage(named: "134.png"), for: .normal)  // 가위
           button15.setImage(UIImage(named: "135.png"), for: .normal)  // 간식
    ...
    var imageTxtList = [
        ...
        imageTxtTupple(image: "122.png", txt: "교과서"),
        imageTxtTupple(image: "123.png", txt: "공책"),
        imageTxtTupple(image: "124.png", txt: "필통"),
        imageTxtTupple(image: "125.png", txt: "연필"),
        imageTxtTupple(image: "126.png", txt: "지우개"),
        imageTxtTupple(image: "127.png", txt: "사물함"),
        imageTxtTupple(image: "128.png", txt: "책상"),
        imageTxtTupple(image: "129.png", txt: "의자"),
        imageTxtTupple(image: "130.png", txt: "가방"),
        imageTxtTupple(image: "131.png", txt: "실내화"),
        imageTxtTupple(image: "132.png", txt: "색연필"),
        imageTxtTupple(image: "1132.png", txt: "사인펜"),
        imageTxtTupple(image: "133.png", txt: "풀"),
        imageTxtTupple(image: "134.png", txt: "가위"),
        imageTxtTupple(image: "135.png", txt: "간식"),
    ]
