...
@available(iOS 15.0, *)
class Dsection: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        button1 .setImage(UIImage(named: "030.png"), for: .normal)  // 밥
        button2 .setImage(UIImage(named: "031.png"), for: .normal)  // 숟가락
        button3 .setImage(UIImage(named: "032.png"), for: .normal)  // 포크
        button4 .setImage(UIImage(named: "033.png"), for: .normal)  // 컵
        button5 .setImage(UIImage(named: "034.png"), for: .normal)  // 가위
        button6 .setImage(UIImage(named: "035.png"), for: .normal)  // 물
        button7 .setImage(UIImage(named: "036.png"), for: .normal)  // 국
        button8 .setImage(UIImage(named: "037.png"), for: .normal)  // 반찬
        button9 .setImage(UIImage(named: "038.png"), for: .normal)  // 김치
        button10.setImage(UIImage(named: "039.png"), for: .normal)  // 계란프라이
        button11.setImage(UIImage(named: "040.png"), for: .normal)  // 피자
        button12.setImage(UIImage(named: "041.png"), for: .normal)  // 생선
        button13.setImage(UIImage(named: "042.png"), for: .normal)  // 삼겹살
        button14.setImage(UIImage(named: "043.png"), for: .normal)  // 초코우유
        button15.setImage(UIImage(named: "044.png"), for: .normal)  // 간식
    ...
    var imageTxtList = [
        ...
        imageTxtTupple(image: "030.png", txt: "밥"),
        imageTxtTupple(image: "031.png", txt: "숟가락"),
        imageTxtTupple(image: "032.png", txt: "포크"),
        imageTxtTupple(image: "033.png", txt: "컵"),
        imageTxtTupple(image: "034.png", txt: "가위"),
        imageTxtTupple(image: "035.png", txt: "물"),
        imageTxtTupple(image: "036.png", txt: "국"),
        imageTxtTupple(image: "037.png", txt: "반찬"),
        imageTxtTupple(image: "038.png", txt: "김치"),
        imageTxtTupple(image: "039.png", txt: "계란프라이"),
        imageTxtTupple(image: "040.png", txt: "피자"),
        imageTxtTupple(image: "041.png", txt: "생선"),
        imageTxtTupple(image: "042.png", txt: "삼겹살"),
        imageTxtTupple(image: "043.png", txt: "초코우유"),
        imageTxtTupple(image: "044.png", txt: "간식")
    ]
