...
@available(iOS 15.0, *)
class SchoolFsection: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        button1  .setImage(UIImage(named: "154.png"), for: .normal)  // 안녕히계세요
           button2  .setImage(UIImage(named: "155.png"), for: .normal)  // 잘가요
           button3  .setImage(UIImage(named: "156.png"), for: .normal)  // 싫어요
           button4  .setImage(UIImage(named: "157.png"), for: .normal)  // 좋아요
           button5  .setImage(UIImage(named: "158.png"), for: .normal)  // 감사해요
           button6  .setImage(UIImage(named: "159.png"), for: .normal)  // 불편해요
           button7  .setImage(UIImage(named: "160.png"), for: .normal)  // 속상해요
           button8  .setImage(UIImage(named: "161.png"), for: .normal)  // 심심해요
           button9  .setImage(UIImage(named: "162.png"), for: .normal)  // 어려워요
           button10 .setImage(UIImage(named: "163.png"), for: .normal)  // 죄송해요
           button11 .setImage(UIImage(named: "164.png"), for: .normal)  // 반가워요
           button12 .setImage(UIImage(named: "165.png"), for: .normal)  // 기뻐요
           button13 .setImage(UIImage(named: "166.png"), for: .normal)  // 최고예요
           button14 .setImage(UIImage(named: "167.png"), for: .normal)  // 아파요
           button15 .setImage(UIImage(named: "168.png"), for: .normal)  // 쉴래요
    ...
    var imageTxtList = [
        ...
        imageTxtTupple(image: "154.png", txt: "안녕히계세요"),
        imageTxtTupple(image: "155.png", txt: "잘가요"),
        imageTxtTupple(image: "156.png", txt: "싫어요"),
        imageTxtTupple(image: "157.png", txt: "좋아요"),
        imageTxtTupple(image: "158.png", txt: "감사해요"),
        imageTxtTupple(image: "159.png", txt: "불편해요"),
        imageTxtTupple(image: "160.png", txt: "속상해요"),
        imageTxtTupple(image: "161.png", txt: "심심해요"),
        imageTxtTupple(image: "162.png", txt: "어려워요"),
        imageTxtTupple(image: "163.png", txt: "죄송해요"),
        imageTxtTupple(image: "164.png", txt: "반가워요"),
        imageTxtTupple(image: "165.png", txt: "기뻐요"),
        imageTxtTupple(image: "166.png", txt: "최고예요"),
        imageTxtTupple(image: "167.png", txt: "아파요"),
        imageTxtTupple(image: "168.png", txt: "쉴래요")
    ]
