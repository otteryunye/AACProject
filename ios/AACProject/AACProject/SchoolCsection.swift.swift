...
@available(iOS 15.0, *)
class SchoolCsection: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        button1  .setImage(UIImage(named: "111.png"), for: .normal)  // 도서실
            button2  .setImage(UIImage(named: "112.png"), for: .normal)  // 과학실
            button3  .setImage(UIImage(named: "113.png"), for: .normal)  // 급식실
            button4  .setImage(UIImage(named: "114.png"), for: .normal)  // 교실
            button5  .setImage(UIImage(named: "115.png"), for: .normal)  // 보건실
            button6  .setImage(UIImage(named: "116.png"), for: .normal)  // 체육관
            button7  .setImage(UIImage(named: "117.png"), for: .normal)  // 음악실
            button8  .setImage(UIImage(named: "118.png"), for: .normal)  // 교무실
            button9  .setImage(UIImage(named: "119.png"), for: .normal)  // 도움반
            button10 .setImage(UIImage(named: "120.png"), for: .normal)  // 운동장
            button11 .setImage(UIImage(named: "121.png"), for: .normal)  // 엘레베이터

//            // 나머지 버튼들은 기본 이미지로 초기화
            button12 .setImage(UIImage(named: "000.png"), for: .normal)
            button13 .setImage(UIImage(named: "000.png"), for: .normal)
            button14 .setImage(UIImage(named: "000.png"), for: .normal)
            button15 .setImage(UIImage(named: "000.png"), for: .normal)
    ...
    var imageTxtList = [
        ...
        imageTxtTupple(image: "111.png", txt: "도서실"),
        imageTxtTupple(image: "112.png", txt: "과학실"),
        imageTxtTupple(image: "113.png", txt: "급식실"),
        imageTxtTupple(image: "114.png", txt: "교실"),
        imageTxtTupple(image: "115.png", txt: "보건실"),
        imageTxtTupple(image: "116.png", txt: "체육관"),
        imageTxtTupple(image: "117.png", txt: "음악실"),
        imageTxtTupple(image: "118.png", txt: "교무실"),
        imageTxtTupple(image: "119.png", txt: "도움반"),
        imageTxtTupple(image: "120.png", txt: "운동장"),
        imageTxtTupple(image: "121.png", txt: "엘레베이터"),
        imageTxtTupple(image: "000.png", txt: " "),
        imageTxtTupple(image: "000.png", txt: " "),
        imageTxtTupple(image: "000.png", txt: " "),
        imageTxtTupple(image: "000.png", txt: " ")
